...
def main() -> None:
    ...
    encrypted_str = encrypt_rail_fence_three(user_string, num_rails)
...
def encrypt_rail_fence_three(user_string: str, num_rails: int) -> str:
    encrypted_str = ''

    for i in range(num_rails):
        encrypted_str += user_string[i::num_rails]
